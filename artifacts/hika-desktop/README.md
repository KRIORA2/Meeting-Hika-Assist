...
|---|---|---|
| `HIKA_API_URL` | `https://hikanest-api-v1.onrender.com` | URL of the Hika API server. Set this only to override the default, for example with a local development API. |
